...
const ENTRIES = [
  ...
  // grammar (14)
  ["what is a noun | what is noun | define noun", "A noun is a word for a person, place, thing or idea. Examples: teacher, city, book, freedom."],
  ["what is a verb | what is verb | define verb", "A verb is a word for an action or a state. Examples: run, eat, be, think."],
  ["what is an adjective | what is adjective | define adjective", "An adjective describes a noun. Examples: big, red, happy."],
  ["what is an adverb | what is adverb | define adverb", "An adverb describes a verb, an adjective or another adverb. Many end in -ly. Examples: quickly, very, well."],
  ["what is a pronoun | what is pronoun | define pronoun", "A pronoun takes the place of a noun. Examples: he, she, it, we, they."],
  ["what is a preposition | what is preposition | define preposition", "A preposition shows place, time or direction. Examples: in, on, at, under, before, to."],
  ["what is a sentence | define sentence", "A sentence is a group of words with a subject and a verb that gives a complete thought. Example: The dog runs."],
  ["how do i make the past tense | what is the past tense | past tense", "For regular verbs add -ed: walk → walked. Irregular verbs change: go → went, eat → ate, see → saw."],
  ["what is the present continuous | how do i make the present continuous", "Use am, is or are + verb-ing for actions happening now. Example: I am reading."],
  ["what is the future tense | how do i make the future tense | future tense", "Use will + verb: I will go. For plans use am, is or are going to + verb: I am going to study."],
  ["what is the difference between a and an | when do i use a and an | a or an", "Use a before a consonant sound (a book) and an before a vowel sound (an apple, an hour)."],
  ["is or are | when do i use is and are | is and are", "Use is with one person or thing (he is, it is). Use are with more than one, and with you (they are, you are)."],
  ["what is the difference between there and their | there or their | their or there", "there = a place (over there). their = belongs to them (their book). they're = they are."],
  ["what is the difference between your and you are | your or you are", "your = belongs to you (your phone). you're = you are (you're late)."],
  ["how do i make a plural | how do i make plurals | plural nouns | what is a plural", "Add -s to most nouns: book → books. Add -es after s, x, ch, sh: box → boxes. Some are irregular: child → children, man → men, foot → feet."],
  ["how do i ask a question in english | how do i make a question | how to ask a question", "Start with a question word (what, where, when, who, why, how) or with do, does, is, are, can. Examples: Do you like tea? Where is the school?"],
  // corrections (7)
  ["can you correct my english | correct my english | check my english | fix my english", "I can fix a few common mistakes. Try a sentence like “I am agree” or “he go to school” and I will show the better form."],
  ["i am agree", "Better: “I agree.” Do not use “am” before “agree”."],
  ["he go to school | she go to school", "Better: “He goes to school.” With he, she or it, add -s or -es to the verb."],
  ["i no know | i no understand", "Better: “I do not know” or “I do not understand.” Use do not before a verb, not “no”."],
  ["i am have a book | i am have", "Better: “I have a book.” Do not use “am” before “have”."],
  ["i go yesterday | i go to school yesterday", "Better: “I went yesterday.” Use the past tense for finished time: go → went."],
  ["more better | more good", "Better: “better”. It is already the comparative form of good, so “more better” is not needed."],
  // help (4)
