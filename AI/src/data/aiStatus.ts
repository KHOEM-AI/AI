...
export interface StatusCard {
  id: string; nameKm: string; nameEn: string; status: StatusCode;
...
export const AI_STATUS_CARDS: StatusCard[] = [
  { id: "core", nameKm: "ខួរចម្បង AI", nameEn: "AI CORE", status: "ONLINE",
  ...
  { id: "memory", nameKm: "ការចងចាំ", nameEn: "MEMORY", status: "READY",
  ...
  { id: "learning", nameKm: "ការរៀន", nameEn: "LEARNING", status: "ACTIVE",
  ...
  { id: "knowledge", nameKm: "មូលដ្ឋានចំណេះដឹង", nameEn: "KNOWLEDGE", status: "READY",
  ...
  { id: "english-brain", nameKm: "ខួរភាសាអង់គ្លេស", nameEn: "ENGLISH BRAIN", status: "DEVELOPING",
  ...
  { id: "khmer-brain", nameKm: "ខួរភាសាខ្មែរ", nameEn: "KHMER BRAIN", status: "ACTIVE",
  ...
  { id: "tools", nameKm: "ឧបករណ៍ AI", nameEn: "TOOLS", status: "READY",
  ...
  { id: "api", nameKm: "ប្រព័ន្ធ API", nameEn: "API", status: "ONLINE",
  ...
  { id: "model", nameKm: "ម៉ូដែល AI", nameEn: "MODEL", status: "ACTIVE",
  ...
  { id: "session", nameKm: "សម័យសន្ទនា", nameEn: "SESSION", status: "ACTIVE",
